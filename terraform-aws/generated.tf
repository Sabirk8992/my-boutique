...
resource "aws_eks_node_group" "ng_general" {
  ...
  subnet_ids             = ["subnet-01d6256069227826f", "subnet-0b271d5cadaa2da49", "subnet-0c895124936cdbd29"]
  tags = {
    "alpha.eksctl.io/cluster-name"                = "online-boutique"
...
# __generated__ by Terraform from "online-boutique"
resource "aws_eks_cluster" "online_boutique" {
  ...
  vpc_config {
    ...
    subnet_ids              = ["subnet-01d6256069227826f", "subnet-0a625a7dcb93e28f8", "subnet-0b271d5cadaa2da49", "subnet-0c895124936cdbd29", "subnet-0e72a38803883c397", "subnet-0f1f53e5385cf9b61"]
  }
}
